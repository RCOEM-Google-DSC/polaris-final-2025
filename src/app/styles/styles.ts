...
export const PreOrderButtons = styled.a`
  display: inline-block;
  background: linear-gradient(
    267.72deg,
    var(--red-light) 0.88%,
  ...
  &::after {
    ...
    height: 70%;
    z-index: -1;
    border-top: 3px solid #000;    /* Changed to black */
    border-left: 3px solid #000;   /* Changed to black */
    transition: 0.7s ease;
  }
  ...
  &::before {
    ...
    height: 70%;
    z-index: -1;
    border-bottom: 3px solid #000; /* Changed to black */
    border-right: 3px solid #000;  /* Changed to black */
    transition: 0.7s ease;
  }
